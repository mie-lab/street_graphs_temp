...
# Kipfnet
config['model']['KipfNet'] = {}
config['model']['KipfNet']['nh1'] = 16
config['model']['KipfNet']['K'] = 7
config['model']['KipfNet']['K_mix'] = 2
config['model']['KipfNet']['inout_skipconn'] = False
